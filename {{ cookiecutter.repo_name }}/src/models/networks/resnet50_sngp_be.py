...
def make_conv2d_batchensemble_layer(
...
def resnet50_sngp_be(
    ...
    """
    Conv2DBatchEnsemble = (
        make_conv2d_batchensemble_layer(  # pylint: disable=invalid-name
            use_spec_norm, spec_norm_iteration, spec_norm_bound
        )
    )
    ...
    return tf.keras.Model(inputs=inputs, outputs=outputs, name="resnet50_be")
